...
namespace CR_import
{
    ...
    public static class oraclehelper
    {
        ...
        private static string connstr = @"Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=173.1.3.88)(PORT=1521)))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=wmrdc)));User Id=wmrdc;Password=wmrdc;";
